...
// Velvet Maroon & Antique Gold palette
const PRIMARY = "#e8c547";   // antique gold
const ACCENT  = "#ff7b94";   // blush crimson
...
export default function BackgroundAnimation({ children }) {
  return (
    <div style={{ position:"relative", width:"100%", height:"100%", overflow:"hidden", background:"#1d0a0d" }}>
      {/* Gold primary blob — top-left */}
      <motion.div style={{
        position:"absolute", width:480, height:400, borderRadius:"50%",
        background:`radial-gradient(circle, rgba(232,197,71,0.20) 0%, transparent 70%)`,
      ...
      <motion.div style={{
        ...
        background:`radial-gradient(circle, rgba(255,123,148,0.18) 0%, transparent 70%)`,
