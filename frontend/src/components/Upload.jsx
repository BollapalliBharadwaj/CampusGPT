...
const STAGES = {
  uploading:{ label:"Uploading file…",        pct:30, color:"var(--primary)" },
  embedding:{ label:"Generating embeddings…", pct:65, color:"var(--accent)" },
  saving:   { label:"Saving to database…",    pct:88, color:"var(--accent)" },
  ready:    { label:"Ready to query!",        pct:100,color:"var(--success)" },
};
  ...
  return (
    ...
    >
      ...
      <div {...getRootProps()} style={{
        borderRadius:10,
        border:`2px dashed ${isDragActive?"var(--primary)":file?"rgba(46,139,87,.5)":"var(--border)"}`,
        background: isDragActive?"var(--primary-dim)":file?"rgba(46,139,87,.03)":"var(--bg)",
